  ...
  /*------------------------------------------------------------------*
   | MACRO NAME  : regress
   | SHORT DESC  : Summary of association between X and Y (Tech
   |               Report 41)
   *------------------------------------------------------------------*
   | CREATED BY  : Stertz, CD                    (04/12/2004 16:00)
   |             : Boos, Christine
   |             : Daood, SL
   *------------------------------------------------------------------*
   | PURPOSE
   |
   | PERFORM POLYNOMIAL REGRESSION ANALYSIS ON XVAR
   ...
   |
   | !!! WARNING !!! - added 5/1/2000 cmb
   |      Before running this macro, all dot codes (.u, etc.) need to be
   |      converted to missings
   |
   | AUTHORS    :  C. D. STERTZ & S. L. DAOOD
   | DATE       :  08/26/88
   |
   | LOCATION   :  SR.JLK.S50400.MACROS
   |
   | CALL
