...
%put >>>> dataset modification datetime stamp is "%modte(test)" >>>>;
%put >>>> dataset modification datetime formatted "%modte(test,datetime19.2)" >>>>;
%put >>>> dataset modification date length 7 is "%modte(test,date7.)" >>>>;
%put >>>> dataset modification date length 9 is "%modte(test,date9.)" >>>>;
