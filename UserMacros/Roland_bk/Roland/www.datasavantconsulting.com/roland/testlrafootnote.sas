...
title1 'first title';
footnote1 'centred first footnote';

%lrafootnote(2,'footnote two left aligned bit', 
"footnote two right aligned bit")
%lrafootnote(3,'footnote 3 left aligned bit only') 
%lrafootnote(4,,"footnote 4 right aligned bit only");
%lrafootnote(5,'footnote 5 left aligned bit that is very long and will not leave much space', "footnote 5 right aligned bit")
