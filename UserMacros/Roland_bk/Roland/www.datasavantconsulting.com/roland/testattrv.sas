...
%put >>>> type of "dummy" var is "%attrv(test,dummy,vartype)" >>>>;
%put >>>> length of "dummy" var is "%attrv(test,dummy,varlen)" >>>>;
%put >>>> label of "dummy" var is "%attrv(test,dummy,varlabel)" >>>>;
%put >>>> format of "dummy" var is "%attrv(test,dummy,varformat)" >>>>;
%put >>>> informat of "dummy" var is "%attrv(test,dummy,varinfmt)" >>>>;

%put >>>> type of "num" var is "%attrv(test,num,vartype)" >>>>;
%put >>>> length of "num" var is "%attrv(test,num,varlen)" >>>>;
%put >>>> label of "num" var is "%attrv(test,num,varlabel)" >>>>;
%put >>>> format of "num" var is "%attrv(test,num,varformat)" >>>>;
%put >>>> informat of "num" var is "%attrv(test,num,varinfmt)" >>>>;
