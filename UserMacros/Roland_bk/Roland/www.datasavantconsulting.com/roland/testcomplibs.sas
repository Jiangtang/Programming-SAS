...
/* Please note that this was originally tested on a Windows platform. */
/* Directory slashes go "\" in Windows. For Unix they go "/".         */

libname was 'c:\aaold';
libname is  'c:\aanew';

data was.ds1;
  a='aaaaa';b='bbbbb';output;
  a='aaaab';b='bbbbc';output;
run;
...
data is.ds1;
  a='aaaaa';b='abbbb';output;
  a='aaaab';b='bbbbc';output;
run;

data is.ds2;
  a='aaaaa';b='bbbbb';output;
  a='aaaab';b='bbbcc';output;
run;

options macrogen;
%complibs('c:\aaold',"c:\aanew")
