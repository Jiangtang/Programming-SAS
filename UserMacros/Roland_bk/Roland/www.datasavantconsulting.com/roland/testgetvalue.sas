...
%put >>>> obs 1 value of "char" is %getvalue(test,char) >>>>;
%put >>>> obs 1 value of "char" again is %getvalue(test,char,1) >>>>;
%put >>>> obs 3 value of "char" is %getvalue(test,char,3) >>>>;

%put >>>> obs 1 value of "num" is %getvalue(test,num) >>>>;
%put >>>> obs 1 value of "num" again is %getvalue(test,num,1) >>>>;
%put >>>> obs 3 value of "num" is %getvalue(test,num,3) >>>>;
