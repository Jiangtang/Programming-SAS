...
%put >>>> dataset creation datetime stamp is "%crdte(test)" >>>>;
%put >>>> dataset creation datetime formatted "%crdte(test,datetime19.2)" >>>>;
%put >>>> dataset creation date length 7 is "%crdte(test,date7.)" >>>>;
%put >>>> dataset creation date length 9 is "%crdte(test,date9.)" >>>>;
