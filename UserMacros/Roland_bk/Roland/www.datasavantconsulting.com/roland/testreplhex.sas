...
characters will be replaced. You might want to use as input the output
...
are ascii non-printable characters suitable for replacing.
*/

/* run it like this when you have a suitable file
%replhex(<input file>,<output file>,'XX'x,'W')
*/

/* This was originally run on the output of testsumtab like this: */

%replhex(testsumtab.lst,testreplhex.txt,'FE'x,'W')
