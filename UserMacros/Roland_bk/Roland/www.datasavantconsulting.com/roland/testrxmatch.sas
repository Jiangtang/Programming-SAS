...
%let match=%rxmatch(apopa pop aapop popaa,pop $s);
%put >>>>> match=&match >>>>> nomatch=&_nomatch_;

%let match=%rxmatch(apopa pop aapop popaa,$p pop);
%put >>>>> match=&match >>>>> nomatch=&_nomatch_;

%let match=%rxmatch(apopa pop aapop popaa,?pop?);
%put >>>>> match=&match >>>>> nomatch=&_nomatch_;
