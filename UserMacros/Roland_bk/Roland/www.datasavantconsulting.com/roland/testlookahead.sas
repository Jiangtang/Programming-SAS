...
subj=1;sdate='07jan2002'd;edate='14jan2002'd;dose=3;output;
subj=1;sdate='14jan2002'd;edate='21jan2002'd;dose=1;output;
subj=2;sdate='14jan2002'd;edate='21jan2002'd;dose=5;output;
format sdate edate date9.;
run;

%lookahead(dsin=test,dsout=test2,bygroup=subj,vars=sdate dose,lookahead=3)
