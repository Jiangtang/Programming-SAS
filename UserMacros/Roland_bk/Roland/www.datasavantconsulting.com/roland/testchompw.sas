...
%put >>>> %chompw(&str,nothing);

%put >>>> %chompw(&str,nothing,0,4);

%put >>>> %chompw(&str,nothing,2,0);

%put >>>> %chompw(&str,nothing,1,1);

%put >>>> %chompw(&str,aa);

%put >>>> %chompw(&str,aa,casesens=yesplease);

%put >>>> %chompw(&str,aa,0,2);

%put >>>> %chompw(&str,aa,2,0);

%put >>>> %chompw(&str,aa,1,1);

%put >>>> %chompw(&str,dd,3);

%put >>>> %chompw(&str,dd,,2);

%put >>>> %chompw(&str,aa,4,1);
