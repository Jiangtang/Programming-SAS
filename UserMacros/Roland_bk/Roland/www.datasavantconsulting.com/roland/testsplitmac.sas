...
%let str=the=quick brown fox jumpedov-er the lazy dog;
%put str=%splitmac(%str(&str),10);

%let str=Roland Rashleigh-Berry is a SAS programmer extrordinaire;
%put str=%splitmac(&str,10);

%let str=Dry, warm and sunny with scatteredd showers;
%put str=%splitmac(%quote(&str),10);
