...
%put >>> *%hasvarsn(test,a c d)* >> *&_nomatch_* ;

%put >>> *%hasvarsn(test,a b c)* >> *&_nomatch_* ;

%put >>> *%hasvarsn(test,A b c)* >> *&_nomatch_* ;

%put >>> *%hasvarsn(test,A b c,casesens=yes)* >> *&_nomatch_* ;

%put >>> *%hasvarsn(test,a b x)* >> *&_nomatch_* ;