...
data test;
  subj=1;sess=3;parm='ALB';value=3.3;output;
  subj=1;sess=1;parm='ALB';value=1.1;output;
  subj=1;sess=1;parm='ALB';value=1.1;output;
  subj=1;sess=2;parm='ALB';value=2.2;output;
run;

%nodupkey(test,subj sess parm)
