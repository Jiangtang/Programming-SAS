...
%dropvars(work._all_,dropme nowant)

%put >> TEST1 vars now %varlist(test1) >>;
%put >> TEST2 vars now %varlist(test2) >>;
%put >> TEST3 vars now %varlist(test3) >>;
