...
%let str=roland width=15 w=22 flow roland='hello world' rat="Roland's place";
%put %after(&str,%str( h=));
%put %after(&str,%str(h=));
%put %after(&str,%str( w=));
%put %after(&str,%str(width=),%str( w=));
%put %after(&str,%str(roland=));
%put %after(&str,%str(rat=));
%put %after(&str,%str(d=));
%put %after(&str,%str(t=));
