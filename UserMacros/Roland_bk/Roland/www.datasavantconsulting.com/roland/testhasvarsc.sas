...
%put >>> *%hasvarsc(test,b e)* >> *&_nomatch_* ;

%put >>> *%hasvarsc(test,a b c)* >> *&_nomatch_* ;

%put >>> *%hasvarsc(test,A b c)* >> *&_nomatch_* ;

%put >>> *%hasvarsc(test,A b c,casesens=yes)* >> *&_nomatch_* ;

%put >>> *%hasvarsc(test,a b x)* >> *&_nomatch_* ;