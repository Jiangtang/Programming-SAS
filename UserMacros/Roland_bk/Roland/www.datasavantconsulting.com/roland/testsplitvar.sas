...
data _null_;
  length str $ 70;
  str='the=quick brown fox jumpedov-er the lazy dog';
  %splitvar(str,10);
  put str=;

  str='Roland Rashleigh-Berry is a SAS programmer extrordinaire';
  %splitvar(str,10);
  put str=;

  str='Dry, warm and sunny with scatteredd showers';
  %splitvar(str,10);
  put str=;
run;
