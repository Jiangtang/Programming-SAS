...
characters will be displayed. You might want to use as input the output
...
are ascii non-printable characters.
*/

/* run it like this when you have a suitable file
%hexchars(<input file>,<output file>)
*/
...
%hexchars(testsumtab.lst,testhexchars.txt)
