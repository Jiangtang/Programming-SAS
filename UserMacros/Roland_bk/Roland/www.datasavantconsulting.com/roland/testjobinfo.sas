...
%*- Note that the macro "jobinfo" needs to be tailored to your platform. -;
%*- This was originally tested on a Windows platform. No further action  -;
%*- than calling the macro is required since it puts out messages for    -;
%*- all the global macro variables it sets up.   -;
