...
/*******************************************************/
/* Generate a dataset with a default variable */
/*******************************************************/
data customers2;
 do iD=1 to 1000;
...
/* use proc freq to investigate % of Good/Bad in 
   the datasets Customers, M, V */

proc freq data=customers2;
 table Default;
run;
proc freq data=M;
 table Default;
...
/*******************************************************/
/* use Proc datasets to examine the details of the  
