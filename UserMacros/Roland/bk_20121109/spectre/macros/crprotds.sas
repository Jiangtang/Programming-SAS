...
loop:
  ...
  if upcase(text) EQ: "DRUGNAME:" then
drugname=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "PROTOCOL:" then
protocol=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "REPORT:" then
report=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "TITLESTYLE:" then
titlestyle=lowcase(left(substr(text,index(text,":")+1)));
  else if upcase(text) EQ: "PAPER:" then
paper=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "MARGIN:" then
margin=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "LMARGIN:" then
lmargin=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "RMARGIN:" then
rmargin=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "TMARGIN:" then
tmargin=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "BMARGIN:" then
bmargin=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "DFLAYOUT:" then
dflayout=upcase(left(substr(text,index(text,":")+1)));
  else if upcase(text) EQ: "DFLLAYOUT:" then
dfllayout=upcase(left(substr(text,index(text,":")+1)));
  else if upcase(text) EQ: "DFPLAYOUT:" then
dfplayout=upcase(left(substr(text,index(text,":")+1)));
  else if upcase(text) EQ: "DFLTLAYOUT:" then
dfltlayout=upcase(left(substr(text,index(text,":")+1)));
  else if upcase(text) EQ: "DFPTLAYOUT:" then
dfptlayout=upcase(left(substr(text,index(text,":")+1)));
  else if upcase(text) EQ: "CLEAN:" then
clean=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "PAGEXOFY:" then
pagexofy=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "PAGEMAC:" then
pagemac=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "POP1:" then
pop1=upcase(left(substr(text,index(text,":")+1)));
  else if upcase(text) EQ: "POPLABEL1:" then
poplabel1=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "POP2:" then
pop2=upcase(left(substr(text,index(text,":")+1)));
  else if upcase(text) EQ: "POPLABEL2:" then
poplabel2=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "POP3:" then
pop3=upcase(left(substr(text,index(text,":")+1)));
  else if upcase(text) EQ: "POPLABEL3:" then
poplabel3=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "POP4:" then
pop4=upcase(left(substr(text,index(text,":")+1)));
  else if upcase(text) EQ: "POPLABEL4:" then
poplabel4=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "POP5:" then
pop5=upcase(left(substr(text,index(text,":")+1)));
  else if upcase(text) EQ: "POPLABEL5:" then
poplabel5=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "POP6:" then
pop6=upcase(left(substr(text,index(text,":")+1)));
  else if upcase(text) EQ: "POPLABEL6:" then
poplabel6=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "POP7:" then
pop7=upcase(left(substr(text,index(text,":")+1)));
  else if upcase(text) EQ: "POPLABEL7:" then
poplabel7=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "POP8:" then
pop8=upcase(left(substr(text,index(text,":")+1)));
  else if upcase(text) EQ: "POPLABEL8:" then
poplabel8=left(substr(text,index(text,":")+1));
  else if upcase(text) EQ: "POP9:" then
pop9=upcase(left(substr(text,index(text,":")+1)));
  else if upcase(text) EQ: "POPLABEL9:" then
poplabel9=left(substr(text,index(text,":")+1));
  goto loop;
eof:
