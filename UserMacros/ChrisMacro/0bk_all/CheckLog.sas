%macro CheckLog(log,ext=LOG,dirext=N,keyword=,exclude=,out=Log_issues,pm=Y,sound=N,to=,cc=,relog=N,shadow=N,abort=N,test=)
     ...
     ********************************************************************************
        ...
        Issues:     The following statements are considered issues. Note that the
                    ...
                    - http://support.sas.com/documentation/cdl/en/hostwin/63285/HTML/default/viewer.htm#oleerr.htm
                    - http://support.sas.com/documentation/cdl/en/hostwin/63285/HTML/default/viewer.htm#resolve.htm
