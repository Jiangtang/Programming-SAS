define table Base.Summary;
   ...
   column class nobs id type ways (varname) (label) (min) (max) (range) (n) (nmiss) (sumwgt) (sum) (mean) (uss) (css) (var) (stddev) (cv) (stderr) (t) (probt) (lclm) (uclm) (skew) (kurt) (median) (mode) (q1) (q3) (qrange) (p1) (p5) (p10) (p20) (p25) (p30)
      (p40) (p50) (p60) (p70) (p75) (p80) (p90) (p95) (p99);
   header h;
   ...
   define probt;
      ...
      define header hprobt;
         text "P{X > |t|}:@ P = tail * [1 - probt(t,df)]@Note: you can also calculate tCritic = tinv(1 - alpha/tail,df)";
         text2 "PROBT";
         split = "@";
      end;
